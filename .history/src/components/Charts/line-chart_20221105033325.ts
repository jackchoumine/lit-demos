...
import { customElement, perty } from 'lit/decorators.js'
...
export class LineChart extends LitElement {
  @perty() dimensions: Dimensions
  @p() source: Source
  @p() height?: string | number = '700px'
  @p() width?: string | number = '100%'
  @p() backgroundColor?: string = '#fdfdfd'
  @p() chartTitle?: string | TitleComponentOption = ''
  @p() yName?: string = ''
  @p() yNameLocation?: 'start' | 'middle' | 'end' = 'end'
  @p() yNameColor?: string = '#000'
  render() {
    return html` <div></div> `
  }
}

...
export class LineChart extends LitElement {
  ...
  @property({ type: Array })
  source
  @property({ type: String }) height = '700px'
  @property({ type: String }) width = '100%'
  @property({ type: String }) backgroundColor = '#fdfdfd'
  @property({ type: String }) chartTitle = ''
  @property({ type: String }) yName = ''
  @property({ type: String }) yNameLocation = 'end'
  @property({ type: String }) yNameColor = '#000'

  render() {
    return html` <div id="chart" style="width:100%"></div> `
  }
}

...
import { customElement, erty } from 'lit/decorators.js'
...
export class LineChart extends LitElement {
  @erty() dimensions: Dimensions
  @() source: Source
  @() height?: string | number = '700px'
  @() width?: string | number = '100%'
  @() backgroundColor?: string = '#fdfdfd'
  @() chartTitle?: string | TitleComponentOption = ''
  @() yName?: string = ''
  @() yNameLocation?: 'start' | 'middle' | 'end' = 'end'
  @() yNameColor?: string = '#000'
  render() {
    return html` <div></div> `
  }
}
